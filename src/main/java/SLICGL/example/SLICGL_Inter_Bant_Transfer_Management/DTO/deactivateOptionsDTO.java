...
public class deactivateOptionsDTO {
    ...
    public deactivateOptionsDTO() {
    }

    public deactivateOptionsDTO(String optionId, LocalDateTime definedDate, String fromAccount, String toAccount, String transferChannel) {
