...
public class getTransferForTransferIdDTO {
    ...
    public getTransferForTransferIdDTO() {
    }

    public getTransferForTransferIdDTO(String transferId, String fromAccount, String toAccount, float transferAmount, String channel, String fromRepo, String toRepo, String approveStatus, String initiatedBy, int isReversed, String crossAdjustment) {
