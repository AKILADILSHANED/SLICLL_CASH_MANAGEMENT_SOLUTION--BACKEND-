    ...
    public ResponseEntity<customAPIResponse<String>> saveTransferOptions(List<saveTransferOptionsDTO> savingOptions) {
        try{
            ...
            return ResponseEntity.status(HttpStatus.OK).body(
                    new customAPIResponse<>(
                            false,
                            "Un-expected error occurred while saving data. Please contact administrator!",
                            null
                    )
            );
        }
    ...
    public ResponseEntity<customAPIResponse<String>> saveDeactivation(String optionId) {
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                    new customAPIResponse<>(
                            false,
                            "Un-expected error occurred while de-activating the option. Please contact administrator!",
                            null
                    )
            );
        }
    ...
    public ResponseEntity<customAPIResponse<String>> saveActivation(String optionId) {
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                    new customAPIResponse<>(
                            false,
                            "Un-expected error occurred while Re-activating the option. Please contact administrator!",
                            null
                    )
            );
        }
    ...
    public ResponseEntity<customAPIResponse<List<availableTransferOptionsDTO>>> availableOptions() {
        try{
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                    new customAPIResponse<>(
                            false,
                            "Un-expected error occurred while fetching the data. Please contact administrator!",
                            null
                    )
            );
        }
            ...
            if(availableOption){
                ...
                if(affectedRows == 0){
                    return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                            new customAPIResponse<>(
                                    false,
                                    "Un-expected error occurred while deleting the option. Please contact administrator!",
                                    null
                            )
                    );
                }else {
